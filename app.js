...
# INSTALL PERSISTENT MENUS
    ...
    example by running the cURL command below:
        ...
        curl -X POST -H "Content-Type: application/json" -d @persistent-menu.json "https://graph.facebook.com/v2.6/me/thread_settings?access_token=EAABdM2cZB9KoBAPi8X3z1VVFFAWHZAWD7oZBcRfksoDL9PcwGgCwZArBnVxFQz1dZAh5vkF1fCVtEZB0bH1ua1EgZBdvQ0PO3a4WdiIZBeCoxQj0x5xtiB7NBZCVTbB3NseviAHemFgOpYeZBrl2L8s5Bi9ZChHmvZC7jZCPFLe3NcaHd9AZDZD"
...
var connector = new builder.ChatConnector({
    appId: "f4f5c804-47c1-41b8-8f30-d1fa3f453ea3",
    appPassword: "wsokoYTkTzNHQ3ryXav4vxN"
});
...
bot.dialog('/', [
    function(session) {
        ...
        builder.Prompts.choice(session, "Would you like to eat something?");
    },
